...
+ Score {
	...
	recordNRTSS_SCMIR { arg oscFilePath, outputFilePath, inputFilePath, sampleRate = 44100, headerFormat =
...
//
	...
	*recordNRTSS_SCMIR { arg list, oscFilePath, outputFilePath, inputFilePath, sampleRate = 44100,
		headerFormat = "AIFF", sampleFormat = "int16", options, completionString="", duration = nil;
		this.new(list).recordNRTSS_SCMIR(oscFilePath, outputFilePath, inputFilePath, sampleRate,
