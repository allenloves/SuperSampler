...
SuperSampler is now a Quark.  However it not yet published to supercollider-quarks list.   Therefore it will not be shown on ```Quarks.gui``` list. To install, type:  
```supercollider
