...
```
Note: There is a bug in SCMIR with SuperCollider 3.7 due to the change of version.  Until Nick update SCMIR to adapt new version of SuperCollider, please do the following to fix this bug: 
