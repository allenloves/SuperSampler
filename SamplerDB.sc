...
SamplerDB{
	...
	*free {
	...
	playEnv {arg env, keynums, amp = 1, pan = 0, dur = nil, numSampler = 2, samplerThickness = 2, morph = [0, 0, \atpeak], diversity = nil, ampenv, panenv, bendenv, out = SSampler.voiceOutputBus, midiChannel = 0;
		...
		Routine.run({
			...
			morphEnvs.do{|thisEnv, envIndex|
				...
				playingSamplers.do{|thisSampler, samplerIndex|
					var score = thisSampler.playEnv(envelope, keynums, dur: dur, amp: amp, pan: pan, maxtexture: samplerThickness, ampenv: ampenv, panenv: panenv, bendenv: bendenv, out: out, midiChannel: midiChannel);
	...
	key {arg keynums, syncmode = \keeplength, numSampler = 3, dur = nil, amp = 1, ampenv = [0, 1, 1, 1], pan = 0, panenv = [0, 0, 1, 0], bendenv = nil, texture = nil, expand = nil, grainRate = 20, grainDur = 0.15, out = SSampler.voiceOutputBus, midiChannel = 0, play = true;
